...
SDL()
{
  ...
  Transfer "$MODULES_DIR/$MODULE/install_${PLATFORM}-$ARCH/bin/SDL2.dll" "$BASE_DIR/../Natives/$PLATFORM/$RID"
}
...
TTF()
{
  ...
  Transfer "$MODULES_DIR/$MODULE/install_${PLATFORM}-$ARCH/bin/SDL2_ttf.dll" "$BASE_DIR/../Natives/$PLATFORM/$RID"
}
