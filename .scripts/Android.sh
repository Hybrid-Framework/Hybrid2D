...
SDL()
{
  ...
  Transfer "$MODULES_DIR/$MODULE/install_${PLATFORM}-$ARCH/lib/libSDL2.so" "$BASE_DIR/../Natives/$PLATFORM/$RID"
}
...
IMAGE()
{
  ...
  Transfer "$MODULES_DIR/$MODULE/install_${PLATFORM}-$ARCH/lib/libSDL2_image.so" "$BASE_DIR/../Natives/$PLATFORM/$RID"
}
...
MIXER()
{
  ...
  Transfer "$MODULES_DIR/$MODULE/install_${PLATFORM}-$ARCH/lib/libSDL2_mixer.so" "$BASE_DIR/../Natives/$PLATFORM/$RID"
}
...
TTF()
{
  ...
  Transfer "$MODULES_DIR/$MODULE/install_${PLATFORM}-$ARCH/lib/libSDL2_ttf.so" "$BASE_DIR/../Natives/$PLATFORM/$RID"
}
