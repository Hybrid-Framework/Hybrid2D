...
internal static unsafe partial class SDL_ttf
{
    ...
    internal static SDL.Font* OpenFont(string path, float size)
    {
    ...
    internal static void CloseFont(SDL.Font* font)
    {
        TTF_CloseFont(font);
    }
    ...
    internal static SDL.Font* CopyFont(SDL.Font* font)
    {
    ...
    internal static bool AddFallbackFont(SDL.Font* font, SDL.Font* fallback)
    {
    ...
    internal static void RemoveFallbackFont(SDL.Font* font, SDL.Font* fallback)
    {
    ...
    internal static void ClearFallbackFonts(SDL.Font* font)
    {
    ...
    internal static bool SetFontSize(SDL.Font* font, float size)
    {
    ...
    internal static float GetFontSize(SDL.Font* font)
    {
    ...
    internal static bool SetFontSizeDPI(SDL.Font* font, float size, int horizontalDPI, int verticalDPI)
    {
    ...
    internal static bool GetFontSizeDPI(SDL.Font* font, out int horizontalDPI, out int verticalDPI)
    {
    ...
    internal static void SetFontStyle(SDL.Font* font, FontStyle style)
    {
    ...
    internal static FontStyle GetFontStyle(SDL.Font* font)
    {
    ...
    internal static bool SetFontOutline(SDL.Font* font, int outline)
    {
    ...
    internal static int GetFontOutline(SDL.Font* font)
    {
    ...
    internal static void SetFontHinting(SDL.Font* font, HintingFlags flags)
    {
    ...
    internal static HintingFlags GetFontHinting(SDL.Font* font)
    {
    ...
    internal static bool SetFontSDF(SDL.Font* font, bool enabled)
    {
    ...
    internal static bool GetFontSDF(SDL.Font* font)
    {
    ...
    internal static FontWeight GetFontWeight(SDL.Font* font)
    {
    ...
    internal static int GetNumFontFaces(SDL.Font* font)
    {
    ...
    internal static void SetFontWrapAlignment(SDL.Font* font, HorizontalAlignment alignment)
    {
    ...
    internal static HorizontalAlignment GetFontWrapAlignment(SDL.Font* font)
    {
    ...
    internal static int GetFontHeight(SDL.Font* font)
    {
    ...
    internal static int GetFontAscent(SDL.Font* font)
    {
    ...
    internal static int GetFontDescent(SDL.Font* font)
    {
    ...
    internal static void SetFontLineSkip(SDL.Font* font, int lineSkip)
    {
    ...
    internal static int GetFontLineSkip(SDL.Font* font)
    {
    ...
    internal static void SetFontKerning(SDL.Font* font, bool enabled)
    {
    ...
    internal static bool GetFontKerning(SDL.Font* font)
    {
    ...
    internal static bool FontIsFixedWidth(SDL.Font* font)
    {
    ...
    internal static bool FontIsScalable(SDL.Font* font)
    {
    ...
    internal static string GetFontFamilyName(SDL.Font* font)
    {
    ...
    internal static string GetFontStyleName(SDL.Font* font)
    {
    ...
    internal static bool SetFontDirection(SDL.Font* font, Direction direction)
    {
    ...
    internal static Direction GetFontDirection(SDL.Font* font)
    {
    ...
    internal static bool SetFontCharSpacing(SDL.Font* font, int spacing)
    {
    ...
    internal static int GetFontCharSpacing(SDL.Font* font)
    {
    ...
    internal static bool GetStringSize(SDL.Font* font, string text, out int w, out int h)
    {
    ...
    internal static bool GetStringSizeWrapped(SDL.Font* font, string text, int wrapWidth, out int w, out int h)
    {
        var bytes = SDL.StringToUtf8(text);
    ...
    internal static bool MeasureString(SDL.Font* font, string text, int maxWidth, out int width, out UIntPtr length)
    {
        var bytes = SDL.StringToUtf8(text);
