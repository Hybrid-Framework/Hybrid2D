...
namespace Hybrid
{
    ...
    {
        private static readonly Dictionary<SDL.ScanCode, KeyboardButton> SDLScanCodeButtonMap = new()
        {
        ...
        private static readonly Dictionary<SDL.KeyCode, KeyboardButton> SDLKeyCodeButtonMap = new()
        {
        ...
        {
            return SDLScanCodeButtonMap.GetValueOrDefault(scanCode);
        }

        internal static KeyboardButton GetKeyboardButtonFromSDLKeyCode(SDL.KeyCode keyCode)
        {
            return SDLKeyCodeButtonMap.GetValueOrDefault(keyCode);
        }
