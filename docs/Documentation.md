...
void Apply(Texture texture) // Update all texture pixels
void Apply(Texture texture, Rectangle rect) // Update section of texture pixels
...
bool IsVisible() // Is screen keyboard visible
bool IsSupported() // Is screen keyboard supported
string GetText() // Get screen keyboard text
```
